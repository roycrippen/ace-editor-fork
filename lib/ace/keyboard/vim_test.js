...
define(function (require, exports, module) {
  ...
  testVim('HML', function (cm, vim, helpers) {
    ...
    helpers.assertCursorAt(0, 2);
    helpers.doKeys('L');
    helpers.assertCursorAt(34, 4);
    helpers.doKeys('M');
    helpers.assertCursorAt(17, 2);
  }, {
      value: (function () {
  ...
  testVim('set_boolean', function (cm, vim, helpers) {
    if (phantom) return;
    CodeMirror.Vim.defineOption('set_boolean', true, 'boolean');
    // Test default value is set.
    is(CodeMirror.Vim.getOption('set_boolean'));
    is(expectFail(function () {
      // Test fail to set to non-boolean
      CodeMirror.Vim.setOption('set_boolean', '5');
    }));
    // Test setOption
    CodeMirror.Vim.setOption('set_boolean', false);
    is(!CodeMirror.Vim.getOption('set_boolean'));
  });
  testVim('ex_set_boolean', function (cm, vim, helpers) {
    if (phantom) return;
    CodeMirror.Vim.defineOption('ex_set_boolean', true, 'boolean');
    // Test default value is set.
    is(CodeMirror.Vim.getOption('ex_set_boolean'));
    is(expectFail(function () {
      // Test fail to set to non-boolean
      CodeMirror.Vim.setOption('ex_set_boolean', 22);
    }));
    // Test setOption
    CodeMirror.Vim.setOption('ex_set_boolean', false);
    is(!CodeMirror.Vim.getOption('ex_set_boolean'));
  });
  testVim('set_string_', function (cm, vim, helpers) {
    if (phantom) return;
    CodeMirror.Vim.defineOption('set_string_', 'a', 'string');
    // Test default value is set.
    eq('a', CodeMirror.Vim.getOption('set_string_'));
    // is(expectFail(function () {                         // does not throw error
    //   // Test fail to set non-string.
    //   CodeMirror.Vim.setOption('set_string_', true);
    // }));
    is(expectFail(function () {
    ...
    // Test setOption
    CodeMirror.Vim.setOption('set_string_', 'c');
    eq('c', CodeMirror.Vim.getOption('set_string_'));
  });
