  ...
  * in the right place.
  ...
  var exCommands = {
    ...
    mdprint: function (cm) {
      var val = cm.ace.getValue();
      // console.log(val);
      // let markdeepRegex = new RegExp("<\\s*script[^>]*src=markdeep[.min]*.js[^>]*>", RegexOptions.IgnoreCase & RegexOptions.Singleline);let markdeepRegex = new RegExp("<\\s*script[^>]*src=markdeep[.min]*.js[^>]*>", RegexOptions.IgnoreCase & RegexOptions.Singleline);
      let markdeepRegex = /<\s*script[^>]*markdeep[.min]*.js[^>]*>/i
      ...
      if(isMarkDeep){
        ...
        w.document.write(val)
        //best bad solution I found
        //note firefox hangs up on load; cancel => proceeding
        setTimeout(function(){ 
    ...
    mds: function (cm) {
      var mds_val = "\n<script src=\"/lib/ace/lib/markdeep.js\"></script>";
      var val = cm.ace.getValue();
