  ...
  * in the right place.
  ...
  var exCommands = {
    ...
    mdprint: function (cm) {
      ...
      w.document.write(val)
      // w.document.DOMContentLoaded.addEventListener(window.print())
      ...
      // w.document.onload(function(){ 
        ...
        // window.close();
        // });
      // w.document.addEventListener.add("load", function(event){ 
      //   window.print();
      //   window.close();
      //   });
      // w.setsleep(500);
      ...
      //   }, 200);  
      // w.close();
      w.addEventListener.add("DOMContentLoaded", w.close())
    },
    mds: function (cm) {
      var mds_val = "<script src=\"markdeep.js\"></script>";
      var val = cm.ace.getValue();
