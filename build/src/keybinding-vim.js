define("ace/keyboard/FileSaver",["require","exports","module"], function(require, exports, module) {
...
define("ace/keyboard/vim",["require","exports","module","ace/range","ace/lib/event_emitter","ace/lib/dom","ace/lib/oop","ace/lib/keys","ace/lib/event","ace/search","ace/lib/useragent","ace/search_highlight","ace/commands/multi_select_commands","ace/mode/text","ace/keyboard/FileSaver","ace/multi_select"], function (require, exports, module) {
  'use strict';
  ...
  var saveAs = require('../keyboard/FileSaver')
  ...
  (function () {
    ...
    this.setOption = function (name, val) {
      ...
      switch (name) {
        ...
        case 'theme':
          name = optMap[name];
          if (val.substr(0, 4) != 'ace/') val = 'ace/theme/' + val;
          break;
        default:
          name = optMap[name];
      }
  ...
  var exCommands = {
    ...
    write: function (cm, params) {
      if (!params.args || params.args.length < 1) {
        showConfirm(cm, cm.getOption('write'));
        return;
      }
      var BB = window.Blob;
